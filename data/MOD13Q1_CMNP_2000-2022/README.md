...
5. Data Quality  
    ...
    5.10. Harmonized Landsat and Sentinel-2 (HLS) Version 2.0  
6. Data Caveats  
7. Documentation  
...
## 1. Request Parameters  
    ...
    Name: Chapada_das_Mesas_National_Park  

    Date Completed: 2022-09-06T14:24:21.947319  

    ID: 559b7267-3cab-4e8e-a9d0-aa909565a41a  

    Details:  

        Input Vector Name:            ret_env_pncm
...
- Chapada-das-Mesas-National-Park-MOD13Q1-006-metadata.xml
- Chapada-das-Mesas-National-Park-granule-list.txt
- Chapada-das-Mesas-National-Park-request.json
- MOD13Q1-006-250m-16-days-VI-Quality-lookup.csv
- MOD13Q1-006-250m-16-days-pixel-reliability-lookup.csv
- MOD13Q1-006-250m-16-days-VI-Quality-Statistics-QA.csv
- MOD13Q1-006-250m-16-days-pixel-reliability-Statistics-QA.csv
- MOD13Q1-006-Statistics.csv

**Data Files:**  

Number of Extracted Data Files: 1,554  
Total Size of Extracted Data Files: 98.77 MB  
...
### HLS v2.0 (HLSL30v002 and HLSS30v002)  
...
- Users should note that working with data near tile borders or with multiple tiles may require reprojection and resampling.
...
- Didan, K. (2015). MOD13Q1 MODIS/Terra Vegetation Indices 16-Day L3 Global 250m SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2022-09-06 from https://doi.org/10.5067/MODIS/MOD13Q1.006. Accessed September 6, 2022.

## 10. Software Citation  

AppEEARS Team. (2022). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.10. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed September 6, 2022. https://appeears.earthdatacloud.nasa.gov
